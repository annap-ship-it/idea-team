...
Проєкт увійшов у фінальну фазу активної розробки. Ми зосередилися на покращенні стабільності, узгодженості UI/UX та загальної продуктивності перед публічним релізом.`,
  ...
  challenge: {
    en: [
    "Regressions in session timers, navigation flow, and video playback"<br/>,
    "Inconsistent UI behavior across iPhone, iPad, and Android (portrait & landscape)"<br/>,
    "Synchronization issues with socket events and time tracking"<br/>,
    "Monolithic code structure with large, hard-to-maintain components"<br/>,
    "Unstable third-party libraries causing freezes and performance issues"<br/>,
    "Lack of localization and limited data visualization"<br/>,
  ],
    uk: [
    "Регресії у таймерах сесій, навігації та відтворенні відео"<br/>,
    "Неконсистентна поведінка UI на iPhone, iPad та Android (портрет / альбом)"<br/>,
    "Проблеми синхронізації socket-подій і відстеження часу"<br/>,
    "Монолітна структура коду та великі компоненти, які важко підтримувати"<br/>,
    "Нестабільні сторонні бібліотеки, що викликали зависання та зниження продуктивності"<br/>,
